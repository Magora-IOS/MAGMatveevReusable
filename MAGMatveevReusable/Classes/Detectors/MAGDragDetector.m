...
@implementation MAGDragDetector
...
- (void)move:(id)sender {
    ...
    if (_canHandleDrag) {
        if (panRecognizer.state == UIGestureRecognizerStateBegan) {
            ...
            CGFloat lesserPositiveAngleInDegreesBetweenCurrentLocationPointAndAxisX = [MAGDragDetector angleBetweenVectorOneWithPointOne:_lastTouchDownPoint withPointTwo:location andVectorTwoWithPointThree:suitableAxisXPositiveVectorP1 withPointFour:suitableAxisXPositiveVectorP2];
